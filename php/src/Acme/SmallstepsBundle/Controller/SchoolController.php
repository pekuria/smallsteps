...
use Acme\SmallstepsBundle\Entity\School;
use Acme\SmallstepsBundle\Form\SchoolType;
...
class SchoolController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AcmeSmallstepsBundle:School')->findAll();

        return $this->render('AcmeSmallstepsBundle:School:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('AcmeSmallstepsBundle:School:new.html.twig', array(
            'entity' => $entity,
    ...
    private function createCreateForm(School $entity)
    {
        $form = $this->createForm(new SchoolType(), $entity, array(
            'action' => $this->generateUrl('Admin_School_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AcmeSmallstepsBundle:School')->find($id);
        ...
        return $this->render('AcmeSmallstepsBundle:School:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AcmeSmallstepsBundle:School:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    {
        $form = $this->createForm(new SchoolType(), $entity, array(
            'action' => $this->generateUrl('Admin_School_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('Admin_School_delete', array('id' => $id)))
            ->setMethod('DELETE')
