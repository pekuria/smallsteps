 ...
 * @ORM\Entity(repositoryClass="Acme\SmallstepsBundle\Repository\PaymentRepository")
 */
class Payment
{
    /**
     ...
     * Set paymentType
     *
     * @param \Acme\SmallstepsBundle\Entity\PaymentMethod $paymentType
     * @return Payment
     */
    public function setPaymentType(\Acme\SmallstepsBundle\Entity\PaymentMethod $paymentType = null)
    {
     ...
     * Get paymentType
     *
     * @return \Acme\SmallstepsBundle\Entity\PaymentMethod 
     */
