 ...
 * @ORM\Entity(repositoryClass="Acme\SmallstepsBundle\Repository\BookingDetailRepository")
 */
class BookingDetail {
   ...
   /**
     ...
     * Set dayslot
     *
     * @param \Acme\SmallstepsBundle\Entity\Timeslot $dayslot
     *
     * @return BookingDetail
     */
    public function setDayslot(\Acme\SmallstepsBundle\Entity\Timeslot $dayslot = null)
    {
     ...
     * Get dayslot
     *
     * @return \Acme\SmallstepsBundle\Entity\Timeslot
     */
